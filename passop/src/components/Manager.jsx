                ...
                {passwordArray.map((item) => {
                  return (
                    <tr>
                      ...
                      <td className='border-x-2 border-x-slate-800'><div className='py-2 px-1 flex items-center w-full gap-3'>{item.password} <FaCopy className='text-slate-800 cursor-pointer size-4 hover:size-5 item-end' onClick={() => { copyText(item.password) }} /></div></td>
